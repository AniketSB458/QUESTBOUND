...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-4 relative overflow-hidden text-neutral-200">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,rgba(34,211,238,0.1),transparent_50%)] pointer-events-none" />
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-cyan-500/70 text-sm tracking-widest mt-1">NEW ENTITY REGISTRATION</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-mono text-neutral-400 mb-1 ml-1 tracking-wider">DESIGNATION (NAME)</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div>
            <label className="block text-xs font-mono text-neutral-400 mb-1 ml-1 tracking-wider">COMM LINK (EMAIL)</label>
            <input
              type="email"
              required
              value={email}
          ...
          <div>
            <label className="block text-xs font-mono text-neutral-400 mb-1 ml-1 tracking-wider">ENCRYPTION KEY (PASSWORD)</label>
            <input
              type="password"
              required
              minLength={6}
