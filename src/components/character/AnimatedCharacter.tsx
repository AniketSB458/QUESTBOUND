...
const getCharacterImage = (charClass: string, level: number) => {
  if (charClass === 'Swordsman') {
    return '/e6632d16-e966-4bee-b07e-be82ee6e542f.png';
  }
  
  if (charClass === 'Ranger') {
    return '/94c31e12-d0f6-40ec-bcba-dd0261bac309.png';
  }
  
  // Mage fallback
  if (level >= 50) return 'https://images.unsplash.com/photo-1618331835717-801e976710b2?auto=format&fit=crop&q=80';
  if (level >= 30) return 'https://images.unsplash.com/photo-1592318051786-9a2503d6d5d5?auto=format&fit=crop&q=80';
  if (level >= 20) return 'https://images.unsplash.com/photo-1534447677768-be436bb09401?auto=format&fit=crop&q=80';
  if (level >= 10) return 'https://images.unsplash.com/photo-1605806616949-1e87b487cb2a?auto=format&fit=crop&q=80';
  return 'https://images.unsplash.com/photo-1514838612111-e633d7dfd1dd?auto=format&fit=crop&q=80';
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        {characterClass === 'Swordsman' && <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1590523278191-995cbcda646b?auto=format&fit=crop&q=80')] bg-cover bg-center mix-blend-overlay opacity-20" />}
        {characterClass === 'Mage' && <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&q=80')] bg-cover bg-center mix-blend-overlay opacity-20" />}
        {characterClass === 'Ranger' && <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1448375240586-882707db8855?auto=format&fit=crop&q=80')] bg-cover bg-center mix-blend-overlay opacity-20" />}
      </motion.div>
