...
export default function ThreeDCharacterDisplay({ characterClass, element, level, interactive = true, className }: Props) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative z-20 w-full max-w-sm aspect-[3/4] flex flex-col items-center justify-center"
        animate={{ 
